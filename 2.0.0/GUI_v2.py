...
class GUI(QMainWindow):
    ...
    def initGUI(self):
        ...
        if self.device_type == "widget":
            ...
            # Retrieve Polygon
            self.retrieve_polygon_button = QPushButton('Retrieve Polygon')
            ...
            grid.addWidget(self.retrieve_polygon_button, 0, 1)
            ...
            grid.addWidget(self.calibrate_button, 1, 1)
            ...
            grid.addWidget(self.align_button, 2, 1)
    ...
    def retrieve_polygon(self):
        print("Retrieve polygon button pressed. Getting polygon_profile...")
    ...
    def calibrate(self):
        ...
        device_steps_per_view_x = 23165  # full device x movement
        device_steps_per_view_y = 17373.75  # full device y movement
