from GUI_v2 import *  # Import your new GUI class
from polygon_tracking_script import main as camera_main
...
class OutputRedirector:
    ...
    def write(self, text):
        ...
        for line in text.splitlines(True):
            if first_line:
                self.console.append(f"[{timestamp}] {line.rstrip()}")
                first_line = False
            else:
...
pixmap = QPixmap(r"C:\Users\Lenovo\Desktop\bg.jpg") # Update this with the actual path to your image file
...
painter.drawText(right_x, right_y, "ver 2.0.1 Designed by Jiahui")
