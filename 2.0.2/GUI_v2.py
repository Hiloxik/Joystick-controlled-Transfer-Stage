...
from polygon_tracking_script import get_polygon, get_shift, main as camera_main
...
class GUI(QMainWindow):
    ...
    def initGUI(self):
        ...
        if self.device_type == "widget":
            ...
            grid.addWidget(self.open_camera_button, 1, 0, 2, 1)
            ...
            grid.addWidget(self.fivefold_button, 0, 1)
            ...
            grid.addWidget(self.tenfold_button, 1, 1)
            ...
            grid.addWidget(self.twentyfold_button, 2, 1)
            ...
            grid.addWidget(self.retrieve_polygon_button, 0, 2)
            ...
            grid.addWidget(self.calibrate_button, 1, 2)
            ...
            grid.addWidget(self.align_button, 2, 2)
    ...
    # Implement open_camera, polygon manipulation methods for camera
    ...
    def fivefold(self):
        global parameters
        parameters["Camera"]["Rescale"] = (23165, 17373.75)
        print(f"Conversion size: {parameters['Camera']['Rescale']}")

    def tenfold(self):
        global parameters
        parameters["Camera"]["Rescale"] = (11582.5, 8686.875)
        print(f"Conversion size: {parameters['Camera']['Rescale']}")

    def twentyfold(self):
        global parameters
        parameters["Camera"]["Rescale"] = (5791.25, 4343.438)
        print(f"Conversion size: {parameters['Camera']['Rescale']}")
