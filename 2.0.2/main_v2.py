...
pixmap = QPixmap(r"C:\Users\Wang_glove box\Desktop\bg.jpg") # Update this with the actual path to your image file
...
painter.drawText(right_x, right_y, "ver 2.0.2 Designed by Jiahui")
