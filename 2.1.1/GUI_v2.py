...
class GUI(QMainWindow):
    ...
    def toggle_switch(self, state):
        if state == Qt.Checked:
            ...
            status_message = "Start designing a device..."
            self.update_status(status_message)
        else:
    ...
    def retrieve_polygon(self):
        status_message = "Retrieve button pressed. Getting flake profile..."
        self.update_status(status_message)

        polygon_profile = get_polygon()  # Replace this with your actual code.
        success_dialog = QMessageBox()
        success_dialog.setWindowTitle("Flake Profile")
        success_dialog.setText(f"Flake profile: {polygon_profile}")
        success_dialog.exec_()

    def calibrate(self):
        global parameters

        status_message = "Calibrate button pressed. Getting shift vector..."
        self.update_status(status_message)
    ...
    def align(self):
        ...
        if self.align_button.text() == "Align Flake":
            ...
            status_message = "Align button pressed. Getting alignment..."
            self.update_status(status_message)
