...
class GUI(QMainWindow):
    ...
    def fivefold(self):
        ...
        globals.parameters["Camera"]["Rescale"] = (25580, 19060)
    ...
    def tenfold(self):
        ...
        globals.parameters["Camera"]["Rescale"] = (25580 / 2, 19060 / 2)
    ...
    def twentyfold(self):
        ...
        globals.parameters["Camera"]["Rescale"] = (25580 / 4, 19060 / 4)
    ...
    def align(self):
        ...
        if self.align_button.text() == "Align Flake":
            ...
            conversion_factor_x = device_steps_per_view_x / camera_pixels_per_view_x
            conversion_factor_y = device_steps_per_view_y / camera_pixels_per_view_y
            conversion_factor_rotate = 41109.17 / (globals.parameters["Sample Stage Rotator"]["CCstep"] / 1000)
