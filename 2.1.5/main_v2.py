...
painter.drawText(right_x, right_y, "ver 2.1.5 Designed by Jiahui")
...
sample_stage_x_group = QGroupBox("Wafer X-Axis")
...
sample_stage_y_group = QGroupBox("Wafer Y-Axis")
...
sample_stage_rotator_group = QGroupBox("Wafer Rotator")
