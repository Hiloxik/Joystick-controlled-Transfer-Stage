...
import sys
sys.path.append('c:/users/optical stm/appdata/local/programs/python/python37/lib/site-packages')

import pylabinstrument
...
clr.AddReference("C:/Program Files/Thorlabs/Kinesis/Thorlabs.MotionControl.TCube.PiezoCLI.dll")
clr.AddReference("C:/Program Files/Thorlabs/Kinesis/Thorlabs.MotionControl.TCube.StrainGaugeCLI.dll")
...
if __name__ == "__main__":
    ...
    mypiezo = PiezoController(97101915)